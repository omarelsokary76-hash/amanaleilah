...
CREATE TABLE IF NOT EXISTS members (
  ...
  public_key TEXT,
  -- الدخول بقى بالـ PIN بدل رقم الهاتف (رقم الهاتف بقى لبيانات التواصل بس). بيتخزن كـ hash (PBKDF2) مش نص صريح.
  pin_hash TEXT,
  -- كود استرجاع لمرة واحدة، لـ"كبير العائلة" بس، لو نسي الـ PIN بتاعه. بيتخزن كـ hash كمان.
