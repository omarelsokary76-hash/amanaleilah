...
// مفتاح الإدارة ثابت هنا في الكود عشان يشتغل من غير أي إعدادات إضافية.
// غيّر القيمة دي لأي كلمة سر تانية تفضلها، وبعدين انشر (deploy) تاني.
const FALLBACK_ADMIN_KEY = 'Amrtallat123456789';

function checkAdminAuth(request, env) {
  // مؤقتًا: من غير كلمة سر خالص، عشان نتأكد إن الباقي شغال. هنرجع نفعّلها تاني بعد كده.
  return true;
}
